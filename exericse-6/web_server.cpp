//
// Created by Trym Hamer Gudvangen on 10/3/23.
//
                         ...
                         [this, connection, read_buffer](const boost::system::error_code &ec, size_t) {
                             ...
                             if (!ec) {
                                 ...
                                 if(message == "GET / HTTP/1.1") {
                                     html_response += "<html><body><h1>This is the main page!</h1></body></html>";
                                 }
                                 else if (message == "GET /en_side HTTP/1.1") {
                                     html_response += "<html><body><h1>This is another page!</h1></body></html>";
                                 } else {
                                     html_response = "HTTP/1.1 404 Not Found";
                                 }
                                 write_stream << html_response;
